...
<script>
    ...
    async function FillUpUpdateForm(id){
        ...
        document.getElementById('customerAddress').value=res.data['address'];
    ...
    async function Update() {
        ...
        if (shop_name.length === 0) {
            errorToast("Customer shop Name Required !")
        }
            ...
            let res = await axios.post("/update-customer",{name:customerName,shop_name:shop_name, address:address, email:customerEmail,mobile:customerMobile,id:updateID})
